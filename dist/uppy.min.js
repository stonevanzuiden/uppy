...
"use strict";var _appendChild=require("yo-yoify/lib/appendChild"),getFileTypeIcon=require("./getFileTypeIcon"),_require=require("./icons"),checkIcon=_require.checkIcon;module.exports=function(e){function t(e){var t=e.target.value,a=e.target.attributes.name.value;f[a]=t}function a(e){return(e||[]).map(function(e){var t;return t=document.createElement("option"),t.setAttribute("value",""+String(e.value)),_appendChild(t,[e.text]),t})}var n,i,r,l,d,s,p,c,o,u,b,m,h,C,y,A=!!e.fileCardFor&&e.files[e.fileCardFor],f={};return p=document.createElement("div"),p.setAttribute("aria-hidden",""+String(!e.fileCardFor)),p.setAttribute("class","UppyDashboardFileCard"),_appendChild(p,[" ",(l=document.createElement("div"),l.setAttribute("class","UppyDashboardContent-bar"),_appendChild(l,[" ",(i=document.createElement("h2"),i.setAttribute("class","UppyDashboardContent-title"),_appendChild(i,["Editing ",(n=document.createElement("span"),n.setAttribute("class","UppyDashboardContent-titleFile"),_appendChild(n,[A.meta?A.meta.name:A.name]),n)]),i)," ",(r=document.createElement("button"),r.setAttribute("title","Finish editing file"),r.onclick=function(){return e.done(f,A.id)},r.setAttribute("class","UppyDashboardContent-back"),r.textContent="Done",r)," "]),l)," ",e.fileCardFor?(h=document.createElement("div"),h.setAttribute("class","UppyDashboardFileCard-inner"),_appendChild(h,[" ",(c=document.createElement("div"),c.setAttribute("class","UppyDashboardFileCard-preview"),_appendChild(c,[" ",A.preview?(C=document.createElement("img"),C.setAttribute("alt",""+String(A.name)),C.setAttribute("src",""+String(A.preview)),C):(y=document.createElement("div"),y.setAttribute("style","color: "+String(getFileTypeIcon(A.type.general,A.type.specific).color)),y.setAttribute("class","UppyDashboardItem-previewIcon"),_appendChild(y,[" ",getFileTypeIcon(A.type.general,A.type.specific).icon," "]),y)," "]),c)," ",(m=document.createElement("div"),m.setAttribute("class","UppyDashboardFileCard-info"),_appendChild(m,[" ",(b=document.createElement("fieldset"),b.setAttribute("class","UppyDashboardFileCard-fieldset"),_appendChild(b,[" ",(o=document.createElement("label"),o.setAttribute("class","UppyDashboardFileCard-label"),o.textContent="Name",o)," ",(u=document.createElement("input"),u.setAttribute("name","name"),u.setAttribute("type","text"),u.setAttribute("value",""+String(A.meta.name)),u.onkeyup=t,u.setAttribute("class","UppyDashboardFileCard-input"),u)," "]),b)," ",function(n){return(e.metaFields||[]).map(function(e){var i,r,l;if("select"===e.type){var d,s,p,c;return c=document.createElement("fieldset"),c.setAttribute("class","UppyDashboardFileCard-fieldset"),_appendChild(c,[" ",(d=document.createElement("label"),d.setAttribute("class","UppyDashboardFileCard-label"),_appendChild(d,[e.name]),d)," ",(p=document.createElement("select"),p.setAttribute("name",""+String(e.id)),p.onchange=t,_appendChild(p,[(s=document.createElement("option"),s.setAttribute("disabled","disabled"),s.setAttribute("selected","selected"),s.textContent="Please select an option",s),a(e.options)]),p)," "]),c}return l=document.createElement("fieldset"),l.setAttribute("class","UppyDashboardFileCard-fieldset"),_appendChild(l,[" ",(i=document.createElement("label"),i.setAttribute("class","UppyDashboardFileCard-label"),_appendChild(i,[e.name]),i)," ",(r=document.createElement("input"),r.setAttribute("name",""+String(e.id)),r.setAttribute("type","text"),r.setAttribute("value",""+String(n.meta[e.id]||"")),r.setAttribute("placeholder",""+String(e.placeholder||"")),r.onkeyup=t,r.setAttribute("class","UppyDashboardFileCard-input"),r)]),l})}(A)," "]),m)," "]),h):null," ",(s=document.createElement("div"),s.setAttribute("class","UppyDashboard-actions"),_appendChild(s,[" ",(d=document.createElement("button"),d.setAttribute("type","button"),d.setAttribute("title","Finish editing file"),d.onclick=function(){return e.done(f,A.id)},d.setAttribute("class","UppyButton--circular UppyButton--blue UppyDashboardFileCard-done"),_appendChild(d,[checkIcon()]),d)," "]),s)," "]),p};
